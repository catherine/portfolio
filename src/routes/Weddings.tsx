...
export const Weddings = () => {
  return (
    <PageContainer>
      <SEO
        title="Wedding Photographer San Francisco Bay Area"
        description="Bay Area wedding photographer capturing candid, documentary-style moments. Natural light wedding photography in San Francisco, Marin, and beyond."
