    ...
    <div className="navbar">
      <div className="navbar-container">
        ...
        <div className="navbar-links">
          <Link to="/">Live Music</Link>
          <Link to="/">Weddings</Link>
          <Link to="/">Contact</Link>
        </div>
      </div>

      {/* Move this to bottom of the page when mobile -- not in the header */}
      <div className="navbar-socialLinks">
        <a
          className="navbar-socialLink"
          href="http://www.instagram.com/cmpatchell"
          target="_blank"
        ...
        <a
          className="navbar-socialLink"
          href="mailto:patchell.catherine@gmail.com?Subject="
          target="_blank"
          rel="noopener noreferrer"
        >
          <svg height={24} width={24}>
        ...
        <a
          className="navbar-socialLink"
          href="https://www.linkedin.com/in/catherinepatchell/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <svg height={24} width={24}>
